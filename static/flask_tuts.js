...
//let loadoriginUri="data:image/svg+xml;utf-8,<svg version='1.1' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='10px' y='0px' width='40px' height='40px' viewBox='0 0 64 80' enable-background='new 0 0 80 90' xml:space='preserve'> <g> <path fill='%23523D7D' d='M64,32C64,14.327,49.673,0,32,0C14.327,0,0,14.327,0,32c0,14.243,9.309,26.308,22.172,30.456L31.942,80 l9.539-17.429C54.524,58.531,64,46.372,64,32z'/> </g> <g> <defs> <circle id='Clip' cx='32' cy='32' r='28'/> </defs> <clipPath id='ClipPath'> <use xlink:href='%23Clip' overflow='visible'/> </clipPath> <image overflow='visible' clip-path='url(%23ClipPath)' width='64' height='70' id='Icon' xlink:href='https://upload.wikimedia.org/wikipedia/commons/e/ed/Map_pin_icon.svg' > </image> </g> </svg>"
